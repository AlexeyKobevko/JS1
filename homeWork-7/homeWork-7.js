 ...
 * @property {int} winFoodCount Длина змейки для победы.
 */
const settings = {
  rowsCount: 21,
  colsCount: 21,
 ...
 * @property {string} maxX Максимальное значение по X.
 * @property {string} maxY Максимальное значение по Y.
 */
const snake = {
  body: null,
  direction: null,
...
const game = {
  ...
  tickHandler() {
    ...
    if (this.food.isOnPoint(this.snake.getNextStepHeadPoint())) {
      ...
      this.snake.growUp();
      // Делаем вызов инкремента для увеличения кол-ва очков в счётчике.
